package com.example.XyhubCommon.Util;
...
public interface ResponseMessages {
	...
	String ALREADY_ASSIGNED = "Ticket is already assigned to this user";
	...
	String PROJECT_DOCUMENT_ADDED = "Project Document_Added Successfully";
	...
	String PO_ID_NOTFOUND = "PUrchase order Id is null";

	String PROJECT_DOCUMENT__EDIT = "Project Document Edited Successfully";
	String PROJECT_DOCUMENT_ID_VALID = "Project DOCUMENT Id Is Not Exists";
	String PROJECT_ID_VALID = "Project Id Is Not Exists";
	
	String VENDOR_ID_NOT_VALID ="Vendor Id is not Exist";
	...
	String ARTICLE_ADDED = "Article created successfully";
	String ARTICLE_NOT_ADDED = "Article not created";
	String ARTICLE_EDITED = "Article edited successfully";
	String TASK_EDITED = "Task edited successfully";
	String TASK_NOT_EDITED = "Task not edited ";
	String ARTICLE_NOT_EDITED = "Article not edited";
	String ARTICLE_STATUS_CHANGED = "Article status changed successfully";
	String ARTICLE_STATUS_NOT_CHANGED = "Article status not changed";
	String ARTICLE_DELETED = "Article deleted successfully";
	String ARTICLE_NOT_DELETED = "Article not deleted";
	String NOT_AUTHORIZED = "Not authorised";
	String ARTICLE_LIST_RETREIVED = "Article list retreived successfully";
	String ARTICLE_LIST_NOT_RETREIVED = "Article list not retreived";
	String ARTICLE_DETAILS_RETREIVED = "Article details retreived successfully";
	String ARTICLE_DETAILS_NOT_RETREIVED = "Article details not retreived";
	...
	String TRAINING_STATUS_CHANGED = "Training status changed successfully";
	String TRAINING_STATUS_NOT_CHANGED = "Training status not changed";
	String ANNOUNCEMENT_DELETED = "Announcement deleted successfully";
	String STOCK_DELETED = "Stock deleted successfully";
	...
	String TRAINING_DETAILS_RETREIVED = "Training details retreived successfully";
	String TRAINING_DETAILS_NOT_RETREIVED = "Training details not retreived";
	String enrollment_added = "Enrollment details submitted successfully";

	String SHEETS_ADDED = "Time Sheets added successfully";
	String SHEETS_NOT_ADDED = "Time Sheets not added";
	String SHEETS_OBJECT_ISSUE = "You can't approve or reject your timesheet";
	...
	String STATIONERY_ADDED = "Stationery added successfully";

	String STATIONERY_NOT_ADDED = "Stationery not added";

	String STOCK_ADDED = "Stock added successfully";

	String STOCK_NOT_ADDED = "Stock not added";

	String stationery_EDITED = "Stationery edited successfully";
	String stock_EDITED = "Stock edited successfully";

	String stationery_NOT_EDITED = "Stationery not added";
	...
	String PURCHASE_ORDER_UPDATED = "Purchase Order Updated successfully";
	...
	String TASK_CREATED = "Created task successfully";
	...
	String DELETE_NOTES = "Notes deleted Successfully";
	String NOTES_NOT_FOUND = "Notes not found";
	
	String BILLING_ADDED = "PurchaseOrder Billing added successfully";
	String BILLING_NOT_ADDED = "Billing not added successfully";
	...
	String Groups_ADDED = "Groups added successfully";
	String Groups_NOT_ADDED = "Groups not added";
	String PRACTICES_ADDED = "Practices added successfully";
	String PRACTICES_NOT_ADDED = "Practices not added";
	...
	String QMS_GROUPS_LIST_RETRIVED = "Groups list retrieved successfully";
	String QMS_PRACTICES_LIST_RETRIVED = "Practices list retrieved successfully";

	String 	UPDATE_PURCHASE_ORDER_BILLING = "Updated Purchase Order Billing Successfully";
	String BILLING_NOT_UPDATED = "Billing not updated Successfully";
	...
	String PURCHASE_ORDER_ADDED ="Purchase Order added";
	...
	String JOB_TITLE_DES_LEN = "Description length should be Min 10 and Max 5000 ";
	...
	String WINGS_Already_EXI = "Wing name already exist";
	...
	String FIRST_NAME_LEN = "First Name must be atleast 3 characters";
	...
	String LAST_NAME_LEN = "Last Name must be atleast 1 character";
	...
	String DES_MAN = "Designation is mandatory";

	String DES_ID_NOT_VAL = "Designation is not valid";

	String DESIGNATION_LEN = "DesignationName length should be greater than 3d and less than 51";

	String DESIGNATION_EXI = " DesignationName already exists!";

	String Des_retrieved = "Designation retrieved successfully";
	...
	String MOB_NUM_MAN = "Mobile Number is mandatory";

	String INCORRECT_MOB = "Incorrect mobile number";
	...
	String from_Date = "From date is mandatory";
	String to_Date = "To date is mandatory";
	...
	String DOB_MAN = "Date of birth is mandatory";

	String ATTENDANCE_DATE_MAN = "Attendance Date is mandatory";

	String GENDER_MAN = "Gender is mandatory";

	String DOJ_NOT_VAL = "Date Of Join is not valid";

	String VENDOR_CREATED = "vendor created successfully";

	String SALARY_UPDATED_SUCCESS = "Salary updated successfully";

	String SALARY_DETAILS_MANDATORY = "Salary details are mandatory";

	String GROSS_SALARY_MAN = "Gross Salary is mandatory";

	String NET_SALARY_MAN = "Net Salary is mandatory";

	String TDS_MAN = "Tds is mandatory";

	String INVALID_DESIGNATION_DETAILS = "DesignationName should not allow character";

	String BIOMETRIC_MAN = "Biometric type is mandatory";

	String Not_Auth = "Not authorised to cancel this ticket";

	String Not_Auth_Resolve = "Not authorised to resolve this ticket";

	String BANK_DETAILS_MANDATORY = "Bank details are mandatory";

	String BANK_NAME_MANDATORY = "Bank name is mandatory";

	String BANK_ACCOUNT_NUMBER_MANDATORY = "Bank account number is mandatory";

	String BANK_ACCOUNT_NUMBER_VAL = "Account number length varies from 9 digits to 18";

	String BANK_IFSC_MANDATORY = "IFCS code is mandatory";

	String BANK_HOLDER_NAME_MANDATORY = "Name on the bank is mandatory";

	String EMPLOYEE_ID_MAN = "Employee Id is mandatory";

	String Loc_exist = "Location name already exists";

	String loc_retrieved = "Locations retrieved successfully";

	String Skill_edited = "Skill edited successfully";

	String skill_not_edited = "Invalid Skill: not able to update";

	String skills_retrieved = "Skills List Retrieved Successfully";

	String not_retrieved = "Could not retrieve data";

	String skill_retrieved = "Skill retrived successfully";

	String skill_already_exist = "Skill already exist";

	String skill_len = "Skill character length should be greater than 2";

	String skill_man = "Skill is mandatory";

	String skill_added = "Skills Added Sccessfully";

	String skill_not_added = "Skills not Added";

	String searchString_empty = "Search string should not be empty";

	String TECHNICAL_VENDOR_CREATED = "Technical vendor created";

	String course_man = "Course is mandatory";
	String stocks_mandatory = "Fields is mandatory";

	String enroll_name = "Enrollment name is mandatory";
	String enroll_len = "Enrollment name should be greater than 3 characters";
	String course_len = "course name should be greater than 3 characters";
	String enroll_mode = "Enrollment mode is mandatory";
	String enroll_profi = "Enrollment proficiency is mandatory";

	String Author_man = "Author is mandatory";

	String Author_val = "Invalid Author";

	String Emp_man = "Number of Employees is mandatory";

	String training_added = "Training added successfully";

	String Training_typ_man = "Training type is mandatory";

	String Training_link_man = "Training link should be mandatory for online mode";

	String Trainings_fetch = "Trainings list retrieved successfully";

	String Trainings_not_found = "No records found";
